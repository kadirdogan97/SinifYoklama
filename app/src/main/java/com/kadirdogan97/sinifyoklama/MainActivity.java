...
import com.kadirdogan97.sinifyoklama.activities.LoginActivity;
import com.kadirdogan97.sinifyoklama.env.BorderedText;
import com.kadirdogan97.sinifyoklama.env.FileUtils;
import com.kadirdogan97.sinifyoklama.env.ImageUtils;
import com.kadirdogan97.sinifyoklama.env.Logger;
import com.kadirdogan97.sinifyoklama.ml.BlazeFace;
import com.kadirdogan97.sinifyoklama.tracking.MultiBoxTracker;
        ...
        runInBackground(
                () -> {
                    ...
                    if(mappedRecognitions.size()>0){
                        Toast.makeText(this, mappedRecognitions.get(0).getTitle()+" "+mappedRecognitions.get(0).getConfidence(), Toast.LENGTH_SHORT).show();
                        if(mappedRecognitions.get(0).getConfidence()>0.75){

                            try {
                                LessonDetailActivity.Companion.setCam("BASARILI");
