...
package com.kadirdogan97.sinifyoklama.tracking;
...
import com.kadirdogan97.sinifyoklama.Recognizer;
import com.kadirdogan97.sinifyoklama.env.BorderedText;
import com.kadirdogan97.sinifyoklama.env.ImageUtils;
import com.kadirdogan97.sinifyoklama.env.Logger;
...
public class MultiBoxTracker {
    ...
    public synchronized void trackResults(
            final List<Recognizer.Recognition> results, final byte[] frame, final long timestamp) {
    ...
    private void processResults(
            final long timestamp, final List<Recognizer.Recognition> results, final byte[] originalFrame) {
        final List<Pair<Float, Recognizer.Recognition>> rectsToTrack = new LinkedList<Pair<Float, Recognizer.Recognition>>();
        ...
        if (objectTracker == null) {
            ...
            for (final Pair<Float, Recognizer.Recognition> potential : rectsToTrack) {
    ...
    private void handleDetection(
            final byte[] frameCopy, final long timestamp, final Pair<Float, Recognizer.Recognition> potential) {
